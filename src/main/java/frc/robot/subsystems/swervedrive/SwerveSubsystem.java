...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    ...
    swerveDrive.setCosineCompensator(false);// !SwerveDriveTelemetry.isSimulation); // Disables
                                            ...
                                            // simulations since it causes discrepancies not seen in
                                            // real life.
  ...
  /**
   * Example approach to the "Coral Station" from the new code: - Wait until
   * elevator is stowed -
   * Approach in two steps
   */
  // public Command driveToCoralStationCommand(Supplier<Boolean>
  // elevatorStowedCheck) {
  ...
  // new Translation2d(-CoralConstants.APPROACH_OFFSET_METERS, 0.0), new
  // Rotation2d()));
  ...
  // return Commands.sequence(Commands.waitUntil((BooleanSupplier)
  // elevatorStowedCheck),
  // approachInTwoSteps);
  // }
