...
public class RobotContainer {
        ...
        SwerveInputStream driveAngularVelocity = SwerveInputStream
                        .of(drivebase.getSwerveDrive(), () -> -auxXbox.getLeftY(),
                                        () -> -auxXbox.getLeftX())
                        .withControllerRotationAxis(() -> -auxXbox.getRightX())
        ...
        SwerveInputStream driveDirectAngle = driveAngularVelocity.copy()
                        .withControllerHeadingAxis(auxXbox::getRightX, auxXbox::getRightY)
                        .headingWhile(true);
        ...
        private void configureBindings() {
                ...
                auxXbox.povUp().onTrue(Commands.runOnce(drivebase::zeroGyro, drivebase));

                driverPS4.square().onTrue(Commands.runOnce(drivebase::lock, drivebase));
        }
