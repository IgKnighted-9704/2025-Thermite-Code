...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                // // R1 => funnel position
                // driverPS4.R1().onTrue(Commands.runOnce(armElevator::funnelPosition,
                // armElevator));
                ...
                driverPS4.L1().whileTrue(
                                Commands.run(() -> {
                                        ...
                                        algaeIntake.intakeForward();
                                                ...
                                                Commands.runOnce(algaeIntake::intakeStop, algaeIntake));

                driverPS4.R1().whileTrue(
                                Commands.run(() -> {
                ...
                // driverPS4.square().whileTrue(Commands.run(climbSubsystem::climb,
                // climbSubsystem))
